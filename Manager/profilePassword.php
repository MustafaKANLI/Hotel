...
<div class="container-flex">
    ...
    <div class="row">
        ...
        if(isset($_POST["old_password"]) and ($_POST["new_password"] != "" or $_POST["new_passwordAgain"] != "")){
...
echo $conn -> error;
        ...
        <div class="container" style="padding: 40px; border: 1px solid; margin-top: 70px; max-height: 800px; max-width: 980px; background-color: #FFFFFF">
            <form method="POST" action="profilePassword.php" id="update">
            <div class="col" align="center" style="padding-bottom: 50px">
                <h2>Change Password</h2>
                <div class="row" align="left" style="margin-top:40px">
                    <div class="col-4">
                        <div class="list-group">
                            <a href="profileInformations.php" class="list-group-item list-group-item-action">
                                Account Details
                            </a>
