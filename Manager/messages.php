                    ...
                    <div class="bg-light border-right" id="sidebar-wrapper">
                        ...
                        <li class="list-group " >
                            ...
                            <ul class="no-bullets">
                                ...
                                <li class="nav-item">
                                    <a href="messages.php" class="list-group-item list-group-item-action bg-primary" style="color:white">
            ...
            <div class="row" style="margin-top: 10rem">
                ...
                <div class="col" style="border: 1px solid; background-color: white; padding:15px; margin-bottom: 30px; overflow:auto; max-height: 500px">
                    ...
                    $select = $conn -> query("SELECT * FROM messages
                                             INNER JOIN customers ON messages.customerid = customers.id
                                             ORDER BY datetime DESC");

                    while ($message = $select ->fetch_assoc()){
                        ...
                        <div class="row" style="border: 1px solid; padding-left: 15px; margin-top: 10px">
                            ...
                            <div class="col-4 align-middle" align="center" style="padding-top: 20px">
                                ...
                                <h6><?php echo $message['fname']  , " ", $message['lname'];  ?></h6>
                            </div>
